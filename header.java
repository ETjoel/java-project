...
public class Header {
    ...
    Header(){
        ...
        body.setBackground(new Color(5, 64, 241));
        ...
        mainPanel.setBackground(new Color(64, 231, 8));
        ...
        homeStartpanel.setBackground(new Color(141, 175, 39));
        ...
        filterpanel.setBackground(new Color(4, 24, 185));
        ...
        apply.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                posts.clear();
                fetchdata(query);
                System.out.println("is filtered");
                for(JPanel p : posts) {
                    mainPanel.add(p);

                    System.out.println("wht the heck is this");
        ...
        topLowerBody.setBackground(new Color(172, 7, 227));
        ...
        lowerTop.setBackground(new Color(122, 85, 236));
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        String sql2 = "SELECT uploadurl,uploademail,uploadphoneno, uploadfirstname, uploadmiddlename, uploadlastname, uploadimage FROM uploadhouse";
        fetchdata(sql2);
        for(JPanel p : posts) {
            mainPanel.add(p);
    ...
    public void fetchdata(String sql2 ){
        try {
            ...
            while (resultSet.next()) {
                ...
                p.nameLabel.addMouseListener(new MouseAdapter() {
                    ...
                    public void mouseClicked(MouseEvent e) {
                        ...
                        ImageIcon iIcon2 = ResizeImageProfile(p.prof, 120, 120);
...
//                        sp.username.setText();
            ...
            System.out.println("Posts have updated");
